...
In this guide we will use [ORY Kratos](https://www.ory.sh/kratos) to build
...
into a React Native application. In this guide, we will focus on these two login
types:

- Username / Email and Password
- ~~Social Sign In / OAuth2 / OpenID Connect~ (work in progress)
  - ~~With "Facebook Login"~ (work in progress)
  - ~~Without "Facebook Login"~ (work in progress)
